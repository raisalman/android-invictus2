...
//                        .header("Content-Type", "application/json")
    ...
    public static RestClientEEN getInstance() {
        if (restClient == null) {
            restClient = new RestClientEEN();
        }
