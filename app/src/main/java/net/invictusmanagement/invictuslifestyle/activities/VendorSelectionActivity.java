...
public class VendorSelectionActivity extends AppCompatActivity implements IRefreshableFragment {
    ...
    private VendorSelectionAdapter adapter;
    private ArrayList<Vendors> arrayList;
    ...
    private void initControls() {
        _context = VendorSelectionActivity.this;
        toolBar();
        initView();
    }
    ...
    private void initView() {
        ...
        tvNoDataFound.setText("No Vendor Found");
...
//                if (adapter != null) {
//                    List<Vendors> list = adapter.getList();
...
//        });
    ...
    private void setAdapterData(List<Vendors> paymentData) {
        arrayList = (ArrayList<Vendors>) paymentData;
        adapter = new VendorSelectionAdapter(_context, paymentData);
    ...
    public void onClick(Vendors item) {
        Intent intent = new Intent();
        intent.putExtra("NAME", item.name);
        intent.putExtra("ID", String.valueOf(item.id));
        intent.putExtra("technicians", item.technicians);
        setResult(RESULT_OK, intent);
        finish();
    }
