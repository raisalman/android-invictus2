...
public class BottomDialog extends DialogFragment implements View.OnClickListener {
    ...
    public BottomDialog(SetOnBottomDialogButtonClick setOnBottomDialogButtonClick) {
    ...
    private void init(View view) {
        ...
        view.findViewById(R.id.tvMine).setOnClickListener(this);
        view.findViewById(R.id.tvFavourite).setOnClickListener(this);
