...
public class BottomChatDialog extends DialogFragment implements View.OnClickListener {
    private SetOnBottomDialogButtonClick setOnBottomDialogButtonClick;

    public BottomChatDialog() {
    }

    @SuppressLint("ValidFragment")
    public BottomChatDialog(SetOnBottomDialogButtonClick setOnBottomDialogButtonClick) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mRootView = inflater.inflate(R.layout.bottom_filter_chat_layout, container, false);
    ...
    private void init(View view) {
        ...
        view.findViewById(R.id.tvPending).setOnClickListener(this);
    ...
    public void dismissDialog() {
        AnimationUtils.slideToDown(mRootView, new AnimationUtils.AnimationListener() {
            ...
            public void onFinish() {
                BottomChatDialog.super.dismiss();
            }
        });
    }
