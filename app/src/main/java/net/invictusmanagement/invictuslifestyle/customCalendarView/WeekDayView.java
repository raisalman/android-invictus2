...
public class WeekDayView extends View {
    ...
    private Paint mEventSpaceBackgroundPaint;
    ...
    private int mHourSeparatorColor = Color.rgb(209, 209, 211);
...
//            ViewCompat.postInvalidateOnAnimation(WeekNoHeaderView.this);
    ...
    private void init() {
        ...
        mEventSpaceBackgroundPaint = new Paint();
        mEventSpaceBackgroundPaint.setColor(getResources().getColor(android.R.color.white));
...
//        canvas.drawRect(0, 0, mTimeTextWidth + mHeaderColumnPadding * 2, 0, mHeaderBackgroundPaint);
    ...
    private void drawTimeColumnAndAxes(Canvas canvas) {
         ...
         *//*float originX = (mWidthPerDay + mColumnGap) * difference;*//*
                float originX = 50f;
        float start = (startPixel < mHeaderColumnWidth ? mHeaderColumnWidth : startPixel);
        canvas.drawLine(originX-2f,0F,originX,300F,mHourSeparatorPaint);*/
        //
...
//                canvas.drawText(time, mTimeTextWidth + mHeaderColumnPadding, top, mCurrentTimeTextPaint);
            ...
            canvas.drawLine(start, 0F, start + 2, mHourHeight * 24, mHourSeparatorPaint);
        ...
        if (mEventRects != null && mEventRects.size() > 0) {
            for (int i = 0; i < mEventRects.size(); i++) {
                if (isSameDay(mEventRects.get(i).event.getStartTime(), date)) {
                    ...
                    RectF eventRectF = new RectF(left + 1, top + 1, right - 1, bottom - 1);
                    RectF eventRectC = new RectF(left, top, right, bottom);
                    if (bottom > 0 + mHeaderMarginBottom + mTimeTextHeight / 2 && left < right &&
                        ...
                        canvas.drawRect(eventRectC, mEventSpaceBackgroundPaint);
